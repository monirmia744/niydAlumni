...
<head>
    ...
    <style>
        ...
        .niyd-logo-badge {
            ...
            margin-right: 15px;
            overflow: hidden;
            box-shadow: 0 4px 12px rgba(13, 45, 92, 0.2);
        }
        ...
        .niyd-full-name {
            ...
            padding-left: 10px;
            margin-left: 10px;
            border-left: 2px solid var(--niyd-accent);
            color: var(--niyd-dark);
            line-height: 1.2;
        }
        ...
        .niyd-nav-link:hover::before,
        .niyd-nav-link.active::before {
            opacity: 1;
            transform: scale(1);
        }

        .niyd-nav-link:hover,
        .niyd-nav-link.active {
            color: white;
        }
        ...
        .scroll-progress {
            ...
            width: 0%;
            height: 3px;
            background: linear-gradient(90deg, var(--niyd-accent), var(--niyd-gold));
            z-index: 1001;
        }
...
<body>
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="d-none d-lg-block">
                <ul class="niyd-nav-menu">
                    <li class="niyd-nav-item">
                        <a href="{{ route('home') }}"
                            class="niyd-nav-link {{ request()->routeIs('home') ? 'active' : '' }}">
                            <i class="bi bi-house-door"></i> Home
                        </a>
                    </li>
                    <li class="niyd-nav-item">
                        <a href="{{ route('alumni') }}"
                            class="niyd-nav-link {{ request()->routeIs('alumni') ? 'active' : '' }}">
                            <i class="bi bi-people"></i> Alumni
                        </a>
                    </li>
                    <li class="niyd-nav-item">
                        <a href="{{ route('event') }}"
                            class="niyd-nav-link {{ request()->routeIs('event') ? 'active' : '' }}">
                            <i class="bi bi-calendar-event"></i> Events
                        </a>
                    </li>
                    <li class="niyd-nav-item">
                        <a href="{{ route('career') }}"
                            class="niyd-nav-link {{ request()->routeIs('career') ? 'active' : '' }}">
                            <i class="bi bi-briefcase"></i> Careers
                        </a>
                    </li>
                    <li class="niyd-nav-item">
                        <a href="{{ route('post') }}"
                            class="niyd-nav-link {{ request()->routeIs('post') ? 'active' : '' }}">
                            <i class="fas fa-newspaper me-2"></i> Posts
                        </a>
                    </li>
                    <li class="niyd-nav-item">
                        <a href="{{ route('contact') }}"
                            class="niyd-nav-link {{ request()->routeIs('contact') ? 'active' : '' }}">
        ...
        <div class="container">
            <div class="row gy-5">
                <div class="col-lg-3">
                    ...
                    <p class="mt-3">Connecting graduates, building strong professional networks, and strengthening
                        lifelong relationships between alumni and institution.</p>
                    <div class="social-icons mt-3">
                        <a href="https://www.facebook.com/p/%E0%A6%9C%E0%A6%BE%E0%A6%A4%E0%A7%80%E0%A7%9F-%E0%A6%AF%E0%A7%81%E0%A6%AC-%E0%A6%89%E0%A6%A8%E0%A7%8D%E0%A6%A8%E0%A7%9F%E0%A6%A8-%E0%A6%87%E0%A6%A8%E0%A6%B8%E0%A7%8D%E0%A6%9F%E0%A6%BF%E0%A6%9F%E0%A6%BF%E0%A6%89%E0%A6%9F-100071194086742/"
            ...
            <div class="footer-bottom text-center">&copy; <span id="year"></span> NIYD Alumni Management System. All
                Rights Reserved. <p>Created By <a href="https://github.com/monirmia744" target="_blank">MONIR MIA</a>
                </p>
            </div>
        </div>
    </footer>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            // ১. টাইপিং ইফেক্ট (Search)
            const searchInput = document.getElementById('typing-search');
            if (searchInput) {
                const phrases = ["Search NIYD...", "Find alumni...", "Browse events...", "Search Job...", "Success Stories"];
                let i = 0, j = 0, isDeleting = false;
                function type() {
                    let current = phrases[i];
                    if (isDeleting) {
                        searchInput.placeholder = current.substring(0, j--);
